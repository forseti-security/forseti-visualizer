...
describe("D3Helpers.test", () => {
  let sut;
  beforeEach(() => {
    sut = _src_services_D3Helpers__WEBPACK_IMPORTED_MODULE_0__["default"];
  });
...
class D3Helpers {
     ...
     * @description gets the document window width/height and document width/height
     */
    getDocumentSize() {
        return {
            window: {
                width: jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width(),
                height: jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height()
            },
            document: {
                width: jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).width(),
                height: jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).height()
            }
        };
    }
}

/* harmony default export */ __webpack_exports__["default"] = (new D3Helpers());
